...
public:
	...
	inline const MouseMovedAction& GetMouseMovedAction() {return aMouseMovedAction;}
	inline void SetMouseMovedAction(const MouseMovedAction&  mouseMovedAction) {aMouseMovedAction = mouseMovedAction;}
...
private:
	std::vector<ButtonAction> aButtonActions;
	std::vector<MouseButtonAction> aMouseButtonActions;
	MouseMovedAction aMouseMovedAction;
};
