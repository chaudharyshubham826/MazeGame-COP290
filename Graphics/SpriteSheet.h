...
public:
	...
	inline const BMPImage& GetBMPImage() const {return aBMPImage;}
	inline uint32_t GetWidth() const {return aBMPImage.GetWidth();}
	inline uint32_t GetHeight() const {return aBMPImage.GetHeight();}
private:
	...
	BMPImage aBMPImage;
	std::vector<BMPImageSection> aSections;
};
